...
public class Messages {
	...
	public static final String ERR_LOGIN_MAILADDRESS_MISTAKE = "メールアドレスに誤りがあります。入力項目を確認し、再度ログインしてください。";
	public static final String ERR_LOGIN_PASSWORD_MISTAKE = "パスワードに誤りがあります。入力項目を確認し、再度ログインしてください。";
	...
	public static final String ACCOUNT_LOCK = "試行回数が上限に達しましたので、<br>アカウントがロックされました。<br>解除したい場合は、管理者に直接連絡してください。";
	/** ユーザ管理 */
